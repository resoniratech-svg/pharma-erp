...
export const seedUsers: UserRole[] = [
  ...
  { id: 'emp-zsm-1', name: 'Vikramaditya Rao', email: 'zsm@pharmaerp.com', mobile: '9876543216', username: 'vikramaditya.r', password: '1234', role: 'Zonal Sales Manager', status: 'Active', lastLogin: 'Today, 08:30 AM', createdBy: 'System', createdDate: '06-Jan-2026', modifiedBy: 'System', modifiedDate: '06-Jan-2026' },
