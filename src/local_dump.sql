...
\restrict rr6hsdZc4BI8ilUeaZ8Kq0iff1wLI4o2Yd3ApcHHIL9vifniYn8osykMDPofAbE
...
ALTER TABLE IF EXISTS ONLY public."WarehouseTransferItem" DROP CONSTRAINT IF EXISTS "WarehouseTransferItem_warehouseTransferId_fkey";
ALTER TABLE IF EXISTS ONLY public."WarehouseTransferItem" DROP CONSTRAINT IF EXISTS "WarehouseTransferItem_productId_fkey";
ALTER TABLE IF EXISTS ONLY public."WarehouseTransferItem" DROP CONSTRAINT IF EXISTS "WarehouseTransferItem_batchId_fkey";
...
ALTER TABLE IF EXISTS ONLY public."TransportChallan" DROP CONSTRAINT IF EXISTS "TransportChallan_dispatchId_fkey";
ALTER TABLE IF EXISTS ONLY public."TourPlan" DROP CONSTRAINT IF EXISTS "TourPlan_mrId_fkey";
ALTER TABLE IF EXISTS ONLY public."TourPlanDoctor" DROP CONSTRAINT IF EXISTS "TourPlanDoctor_tourPlanId_fkey";
ALTER TABLE IF EXISTS ONLY public."TourPlanDoctor" DROP CONSTRAINT IF EXISTS "TourPlanDoctor_doctorId_fkey";
ALTER TABLE IF EXISTS ONLY public."TourPlanChemist" DROP CONSTRAINT IF EXISTS "TourPlanChemist_tourPlanId_fkey";
ALTER TABLE IF EXISTS ONLY public."TourPlanChemist" DROP CONSTRAINT IF EXISTS "TourPlanChemist_chemistId_fkey";
ALTER TABLE IF EXISTS ONLY public."Target" DROP CONSTRAINT IF EXISTS "Target_mrId_fkey";
ALTER TABLE IF EXISTS ONLY public."StockMovement" DROP CONSTRAINT IF EXISTS "StockMovement_inventoryId_fkey";
ALTER TABLE IF EXISTS ONLY public."SchemeMaster" DROP CONSTRAINT IF EXISTS "SchemeMaster_productId_fkey";
ALTER TABLE IF EXISTS ONLY public."SchemeMaster" DROP CONSTRAINT IF EXISTS "SchemeMaster_batchId_fkey";
ALTER TABLE IF EXISTS ONLY public."RolePermission" DROP CONSTRAINT IF EXISTS "RolePermission_featureId_fkey";
ALTER TABLE IF EXISTS ONLY public."RolePermission" DROP CONSTRAINT IF EXISTS "RolePermission_companyId_fkey";
ALTER TABLE IF EXISTS ONLY public."Retailer" DROP CONSTRAINT IF EXISTS "Retailer_stockistId_fkey";
ALTER TABLE IF EXISTS ONLY public."RetailerOrder" DROP CONSTRAINT IF EXISTS "RetailerOrder_stockistId_fkey";
ALTER TABLE IF EXISTS ONLY public."RetailerOrder" DROP CONSTRAINT IF EXISTS "RetailerOrder_retailerId_fkey";
ALTER TABLE IF EXISTS ONLY public."RetailerOrder" DROP CONSTRAINT IF EXISTS "RetailerOrder_mrId_fkey";
ALTER TABLE IF EXISTS ONLY public."RetailerOrder" DROP CONSTRAINT IF EXISTS "RetailerOrder_hospitalId_fkey";
ALTER TABLE IF EXISTS ONLY public."RetailerOrder" DROP CONSTRAINT IF EXISTS "RetailerOrder_chemistId_fkey";
ALTER TABLE IF EXISTS ONLY public."RetailerOrderItem" DROP CONSTRAINT IF EXISTS "RetailerOrderItem_retailerOrderId_fkey";
ALTER TABLE IF EXISTS ONLY public."RetailerOrderItem" DROP CONSTRAINT IF EXISTS "RetailerOrderItem_productId_fkey";
...
ALTER TABLE IF EXISTS ONLY public."PricingMaster" DROP CONSTRAINT IF EXISTS "PricingMaster_productId_fkey";
ALTER TABLE IF EXISTS ONLY public."PricingMaster" DROP CONSTRAINT IF EXISTS "PricingMaster_batchId_fkey";
ALTER TABLE IF EXISTS ONLY public."PaymentCollection" DROP CONSTRAINT IF EXISTS "PaymentCollection_invoiceId_fkey";
ALTER TABLE IF EXISTS ONLY public."OutwardStock" DROP CONSTRAINT IF EXISTS "OutwardStock_warehouseId_fkey";
ALTER TABLE IF EXISTS ONLY public."OutwardStockItem" DROP CONSTRAINT IF EXISTS "OutwardStockItem_productId_fkey";
ALTER TABLE IF EXISTS ONLY public."OutwardStockItem" DROP CONSTRAINT IF EXISTS "OutwardStockItem_outwardStockId_fkey";
ALTER TABLE IF EXISTS ONLY public."OutwardStockItem" DROP CONSTRAINT IF EXISTS "OutwardStockItem_batchId_fkey";
ALTER TABLE IF EXISTS ONLY public."Notification" DROP CONSTRAINT IF EXISTS "Notification_mrId_fkey";
ALTER TABLE IF EXISTS ONLY public."Meeting" DROP CONSTRAINT IF EXISTS "Meeting_mrId_fkey";
ALTER TABLE IF EXISTS ONLY public."Meeting" DROP CONSTRAINT IF EXISTS "Meeting_doctorId_fkey";
ALTER TABLE IF EXISTS ONLY public."Meeting" DROP CONSTRAINT IF EXISTS "Meeting_chemistId_fkey";
ALTER TABLE IF EXISTS ONLY public."MeetingStockist" DROP CONSTRAINT IF EXISTS "MeetingStockist_stockistId_fkey";
ALTER TABLE IF EXISTS ONLY public."MeetingStockist" DROP CONSTRAINT IF EXISTS "MeetingStockist_meetingId_fkey";
ALTER TABLE IF EXISTS ONLY public."MeetingHospital" DROP CONSTRAINT IF EXISTS "MeetingHospital_meetingId_fkey";
ALTER TABLE IF EXISTS ONLY public."MeetingHospital" DROP CONSTRAINT IF EXISTS "MeetingHospital_hospitalId_fkey";
ALTER TABLE IF EXISTS ONLY public."MeetingDoctor" DROP CONSTRAINT IF EXISTS "MeetingDoctor_meetingId_fkey";
ALTER TABLE IF EXISTS ONLY public."MeetingDoctor" DROP CONSTRAINT IF EXISTS "MeetingDoctor_doctorId_fkey";
ALTER TABLE IF EXISTS ONLY public."MeetingChemist" DROP CONSTRAINT IF EXISTS "MeetingChemist_meetingId_fkey";
ALTER TABLE IF EXISTS ONLY public."MeetingChemist" DROP CONSTRAINT IF EXISTS "MeetingChemist_chemistId_fkey";
ALTER TABLE IF EXISTS ONLY public."MR" DROP CONSTRAINT IF EXISTS "MR_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."Ledger" DROP CONSTRAINT IF EXISTS "Ledger_retailerId_fkey";
ALTER TABLE IF EXISTS ONLY public."LeaveRequest" DROP CONSTRAINT IF EXISTS "LeaveRequest_mrId_fkey";
ALTER TABLE IF EXISTS ONLY public."Lead" DROP CONSTRAINT IF EXISTS "Lead_assignedMrId_fkey";
ALTER TABLE IF EXISTS ONLY public."LRTracking" DROP CONSTRAINT IF EXISTS "LRTracking_transportChallanId_fkey";
ALTER TABLE IF EXISTS ONLY public."InwardStock" DROP CONSTRAINT IF EXISTS "InwardStock_warehouseId_fkey";
ALTER TABLE IF EXISTS ONLY public."InwardStock" DROP CONSTRAINT IF EXISTS "InwardStock_supplierId_fkey";
ALTER TABLE IF EXISTS ONLY public."InwardStockItem" DROP CONSTRAINT IF EXISTS "InwardStockItem_productId_fkey";
ALTER TABLE IF EXISTS ONLY public."InwardStockItem" DROP CONSTRAINT IF EXISTS "InwardStockItem_inwardStockId_fkey";
ALTER TABLE IF EXISTS ONLY public."Invoice" DROP CONSTRAINT IF EXISTS "Invoice_retailerId_fkey";
...
ALTER TABLE IF EXISTS ONLY public."Inventory" DROP CONSTRAINT IF EXISTS "Inventory_batchId_fkey";
ALTER TABLE IF EXISTS ONLY public."FollowUp" DROP CONSTRAINT IF EXISTS "FollowUp_mrId_fkey";
ALTER TABLE IF EXISTS ONLY public."FollowUp" DROP CONSTRAINT IF EXISTS "FollowUp_meetingId_fkey";
ALTER TABLE IF EXISTS ONLY public."FollowUp" DROP CONSTRAINT IF EXISTS "FollowUp_doctorId_fkey";
ALTER TABLE IF EXISTS ONLY public."FollowUp" DROP CONSTRAINT IF EXISTS "FollowUp_chemistId_fkey";
ALTER TABLE IF EXISTS ONLY public."Feature" DROP CONSTRAINT IF EXISTS "Feature_moduleId_fkey";
ALTER TABLE IF EXISTS ONLY public."ExpenseClaim" DROP CONSTRAINT IF EXISTS "ExpenseClaim_mrId_fkey";
ALTER TABLE IF EXISTS ONLY public."DoctorVisit" DROP CONSTRAINT IF EXISTS "DoctorVisit_mrId_fkey";
ALTER TABLE IF EXISTS ONLY public."DoctorVisit" DROP CONSTRAINT IF EXISTS "DoctorVisit_doctorId_fkey";
ALTER TABLE IF EXISTS ONLY public."Dispatch" DROP CONSTRAINT IF EXISTS "Dispatch_warehouseId_fkey";
ALTER TABLE IF EXISTS ONLY public."Dispatch" DROP CONSTRAINT IF EXISTS "Dispatch_batchId_fkey";
ALTER TABLE IF EXISTS ONLY public."DeliveryTracking" DROP CONSTRAINT IF EXISTS "DeliveryTracking_lrTrackingId_fkey";
ALTER TABLE IF EXISTS ONLY public."DailyReport" DROP CONSTRAINT IF EXISTS "DailyReport_mrId_fkey";
ALTER TABLE IF EXISTS ONLY public."CreditNote" DROP CONSTRAINT IF EXISTS "CreditNote_retailerId_fkey";
ALTER TABLE IF EXISTS ONLY public."CreditNote" DROP CONSTRAINT IF EXISTS "CreditNote_mrId_fkey";
ALTER TABLE IF EXISTS ONLY public."CreditNote" DROP CONSTRAINT IF EXISTS "CreditNote_distributorId_fkey";
ALTER TABLE IF EXISTS ONLY public."CreditNote" DROP CONSTRAINT IF EXISTS "CreditNote_approvedByUserId_fkey";
ALTER TABLE IF EXISTS ONLY public."CreditNote" DROP CONSTRAINT IF EXISTS "CreditNote_againstInvoiceId_fkey";
ALTER TABLE IF EXISTS ONLY public."CreditNoteItem" DROP CONSTRAINT IF EXISTS "CreditNoteItem_productId_fkey";
ALTER TABLE IF EXISTS ONLY public."CreditNoteItem" DROP CONSTRAINT IF EXISTS "CreditNoteItem_creditNoteId_fkey";
ALTER TABLE IF EXISTS ONLY public."CreditNoteItem" DROP CONSTRAINT IF EXISTS "CreditNoteItem_batchId_fkey";
ALTER TABLE IF EXISTS ONLY public."CompanyFeaturePermission" DROP CONSTRAINT IF EXISTS "CompanyFeaturePermission_featureId_fkey";
ALTER TABLE IF EXISTS ONLY public."CompanyFeaturePermission" DROP CONSTRAINT IF EXISTS "CompanyFeaturePermission_companyId_fkey";
ALTER TABLE IF EXISTS ONLY public."ChemistVisit" DROP CONSTRAINT IF EXISTS "ChemistVisit_mrId_fkey";
ALTER TABLE IF EXISTS ONLY public."ChemistVisit" DROP CONSTRAINT IF EXISTS "ChemistVisit_chemistId_fkey";
...
ALTER TABLE IF EXISTS ONLY public."Attendance" DROP CONSTRAINT IF EXISTS "Attendance_mrId_fkey";
ALTER TABLE IF EXISTS ONLY public."Activity" DROP CONSTRAINT IF EXISTS "Activity_mrId_fkey";
DROP INDEX IF EXISTS public."Warehouse_code_key";
DROP INDEX IF EXISTS public."WarehouseTransfer_transferNo_key";
DROP INDEX IF EXISTS public."User_email_key";
DROP INDEX IF EXISTS public."TransportChallan_challanNumber_key";
DROP INDEX IF EXISTS public."Supplier_name_key";
DROP INDEX IF EXISTS public."Stockist_code_key";
DROP INDEX IF EXISTS public."SchemeMaster_code_key";
DROP INDEX IF EXISTS public."Retailer_code_key";
DROP INDEX IF EXISTS public."RetailerOrder_orderNumber_key";
DROP INDEX IF EXISTS public."Product_code_key";
DROP INDEX IF EXISTS public."ProductCategory_name_key";
DROP INDEX IF EXISTS public."PackingType_code_key";
DROP INDEX IF EXISTS public."OutwardStock_dispatchNo_key";
DROP INDEX IF EXISTS public."Module_name_key";
DROP INDEX IF EXISTS public."MR_userId_key";
DROP INDEX IF EXISTS public."MR_mrCode_key";
DROP INDEX IF EXISTS public."Lead_leadCode_key";
DROP INDEX IF EXISTS public."LRTracking_lrNumber_key";
DROP INDEX IF EXISTS public."InwardStock_grnNo_key";
DROP INDEX IF EXISTS public."Invoice_invoiceNumber_key";
DROP INDEX IF EXISTS public."HSNCode_code_key";
DROP INDEX IF EXISTS public."Doctor_doctorCode_key";
DROP INDEX IF EXISTS public."CreditNote_cnNo_key";
DROP INDEX IF EXISTS public."CompanyFeaturePermission_companyId_featureId_key";
DROP INDEX IF EXISTS public."Chemist_chemistCode_key";
ALTER TABLE IF EXISTS ONLY public._prisma_migrations DROP CONSTRAINT IF EXISTS _prisma_migrations_pkey;
ALTER TABLE IF EXISTS ONLY public."Warehouse" DROP CONSTRAINT IF EXISTS "Warehouse_pkey";
ALTER TABLE IF EXISTS ONLY public."WarehouseTransfer" DROP CONSTRAINT IF EXISTS "WarehouseTransfer_pkey";
ALTER TABLE IF EXISTS ONLY public."WarehouseTransferItem" DROP CONSTRAINT IF EXISTS "WarehouseTransferItem_pkey";
ALTER TABLE IF EXISTS ONLY public."User" DROP CONSTRAINT IF EXISTS "User_pkey";
ALTER TABLE IF EXISTS ONLY public."TransportChallan" DROP CONSTRAINT IF EXISTS "TransportChallan_pkey";
ALTER TABLE IF EXISTS ONLY public."TourPlan" DROP CONSTRAINT IF EXISTS "TourPlan_pkey";
ALTER TABLE IF EXISTS ONLY public."TourPlanDoctor" DROP CONSTRAINT IF EXISTS "TourPlanDoctor_pkey";
ALTER TABLE IF EXISTS ONLY public."TourPlanChemist" DROP CONSTRAINT IF EXISTS "TourPlanChemist_pkey";
ALTER TABLE IF EXISTS ONLY public."TerritoryBeat" DROP CONSTRAINT IF EXISTS "TerritoryBeat_pkey";
ALTER TABLE IF EXISTS ONLY public."Target" DROP CONSTRAINT IF EXISTS "Target_pkey";
ALTER TABLE IF EXISTS ONLY public."Supplier" DROP CONSTRAINT IF EXISTS "Supplier_pkey";
ALTER TABLE IF EXISTS ONLY public."Stockist" DROP CONSTRAINT IF EXISTS "Stockist_pkey";
ALTER TABLE IF EXISTS ONLY public."StockMovement" DROP CONSTRAINT IF EXISTS "StockMovement_pkey";
ALTER TABLE IF EXISTS ONLY public."SchemeMaster" DROP CONSTRAINT IF EXISTS "SchemeMaster_pkey";
...
ALTER TABLE IF EXISTS ONLY public."RetailerOrder" DROP CONSTRAINT IF EXISTS "RetailerOrder_pkey";
ALTER TABLE IF EXISTS ONLY public."RetailerOrderItem" DROP CONSTRAINT IF EXISTS "RetailerOrderItem_pkey";
ALTER TABLE IF EXISTS ONLY public."Product" DROP CONSTRAINT IF EXISTS "Product_pkey";
ALTER TABLE IF EXISTS ONLY public."ProductCategory" DROP CONSTRAINT IF EXISTS "ProductCategory_pkey";
ALTER TABLE IF EXISTS ONLY public."PricingMaster" DROP CONSTRAINT IF EXISTS "PricingMaster_pkey";
ALTER TABLE IF EXISTS ONLY public."PaymentCollection" DROP CONSTRAINT IF EXISTS "PaymentCollection_pkey";
ALTER TABLE IF EXISTS ONLY public."PackingType" DROP CONSTRAINT IF EXISTS "PackingType_pkey";
ALTER TABLE IF EXISTS ONLY public."OutwardStock" DROP CONSTRAINT IF EXISTS "OutwardStock_pkey";
ALTER TABLE IF EXISTS ONLY public."OutwardStockItem" DROP CONSTRAINT IF EXISTS "OutwardStockItem_pkey";
...
ALTER TABLE IF EXISTS ONLY public."MeetingStockist" DROP CONSTRAINT IF EXISTS "MeetingStockist_pkey";
ALTER TABLE IF EXISTS ONLY public."MeetingHospital" DROP CONSTRAINT IF EXISTS "MeetingHospital_pkey";
ALTER TABLE IF EXISTS ONLY public."MeetingDoctor" DROP CONSTRAINT IF EXISTS "MeetingDoctor_pkey";
ALTER TABLE IF EXISTS ONLY public."MeetingChemist" DROP CONSTRAINT IF EXISTS "MeetingChemist_pkey";
ALTER TABLE IF EXISTS ONLY public."MR" DROP CONSTRAINT IF EXISTS "MR_pkey";
...
ALTER TABLE IF EXISTS ONLY public."LRTracking" DROP CONSTRAINT IF EXISTS "LRTracking_pkey";
ALTER TABLE IF EXISTS ONLY public."InwardStock" DROP CONSTRAINT IF EXISTS "InwardStock_pkey";
ALTER TABLE IF EXISTS ONLY public."InwardStockItem" DROP CONSTRAINT IF EXISTS "InwardStockItem_pkey";
...
ALTER TABLE IF EXISTS ONLY public."HSNCode" DROP CONSTRAINT IF EXISTS "HSNCode_pkey";
ALTER TABLE IF EXISTS ONLY public."GSTRecord" DROP CONSTRAINT IF EXISTS "GSTRecord_pkey";
ALTER TABLE IF EXISTS ONLY public."FollowUp" DROP CONSTRAINT IF EXISTS "FollowUp_pkey";
...
ALTER TABLE IF EXISTS ONLY public."ExpenseClaim" DROP CONSTRAINT IF EXISTS "ExpenseClaim_pkey";
ALTER TABLE IF EXISTS ONLY public."Doctor" DROP CONSTRAINT IF EXISTS "Doctor_pkey";
ALTER TABLE IF EXISTS ONLY public."DoctorVisit" DROP CONSTRAINT IF EXISTS "DoctorVisit_pkey";
ALTER TABLE IF EXISTS ONLY public."Distributor" DROP CONSTRAINT IF EXISTS "Distributor_pkey";
ALTER TABLE IF EXISTS ONLY public."Dispatch" DROP CONSTRAINT IF EXISTS "Dispatch_pkey";
ALTER TABLE IF EXISTS ONLY public."DeliveryTracking" DROP CONSTRAINT IF EXISTS "DeliveryTracking_pkey";
ALTER TABLE IF EXISTS ONLY public."DailyReport" DROP CONSTRAINT IF EXISTS "DailyReport_pkey";
...
ALTER TABLE IF EXISTS ONLY public."CompanyFeaturePermission" DROP CONSTRAINT IF EXISTS "CompanyFeaturePermission_pkey";
ALTER TABLE IF EXISTS ONLY public."Chemist" DROP CONSTRAINT IF EXISTS "Chemist_pkey";
ALTER TABLE IF EXISTS ONLY public."ChemistVisit" DROP CONSTRAINT IF EXISTS "ChemistVisit_pkey";
...
ALTER TABLE IF EXISTS public."WarehouseTransferItem" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."WarehouseTransfer" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Warehouse" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."User" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."TransportChallan" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."TourPlanDoctor" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."TourPlanChemist" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."TourPlan" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."TerritoryBeat" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Target" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Supplier" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Stockist" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."StockMovement" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."SchemeMaster" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."RolePermission" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."RetailerOrderItem" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."RetailerOrder" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Retailer" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."ProductCategory" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Product" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."PricingMaster" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."PaymentCollection" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."PackingType" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."OutwardStockItem" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."OutwardStock" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Notification" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Module" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."MeetingStockist" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."MeetingHospital" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."MeetingDoctor" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."MeetingChemist" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Meeting" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."MR" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Ledger" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."LeaveRequest" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Lead" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."LRTracking" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."InwardStockItem" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."InwardStock" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."InvoiceItem" ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public."Hospital" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."HSNCode" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."GSTRecord" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."FollowUp" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Feature" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."ExpenseClaim" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Expense" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."DoctorVisit" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Doctor" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Distributor" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Dispatch" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."DeliveryTracking" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."DailyReport" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."CreditNoteItem" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."CreditNote" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."CompanyFeaturePermission" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Company" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."ChemistVisit" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Chemist" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Branch" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public."Batch" ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public."WarehouseTransfer_id_seq";
DROP SEQUENCE IF EXISTS public."WarehouseTransferItem_id_seq";
DROP TABLE IF EXISTS public."WarehouseTransferItem";
DROP TABLE IF EXISTS public."WarehouseTransfer";
DROP TABLE IF EXISTS public."Warehouse";
DROP SEQUENCE IF EXISTS public."User_id_seq";
DROP TABLE IF EXISTS public."User";
DROP SEQUENCE IF EXISTS public."TransportChallan_id_seq";
DROP TABLE IF EXISTS public."TransportChallan";
DROP SEQUENCE IF EXISTS public."TourPlan_id_seq";
DROP SEQUENCE IF EXISTS public."TourPlanDoctor_id_seq";
DROP TABLE IF EXISTS public."TourPlanDoctor";
DROP SEQUENCE IF EXISTS public."TourPlanChemist_id_seq";
DROP TABLE IF EXISTS public."TourPlanChemist";
DROP TABLE IF EXISTS public."TourPlan";
DROP SEQUENCE IF EXISTS public."TerritoryBeat_id_seq";
DROP TABLE IF EXISTS public."TerritoryBeat";
DROP SEQUENCE IF EXISTS public."Target_id_seq";
DROP TABLE IF EXISTS public."Target";
DROP SEQUENCE IF EXISTS public."Supplier_id_seq";
DROP TABLE IF EXISTS public."Supplier";
DROP SEQUENCE IF EXISTS public."Stockist_id_seq";
DROP TABLE IF EXISTS public."Stockist";
DROP SEQUENCE IF EXISTS public."StockMovement_id_seq";
DROP TABLE IF EXISTS public."StockMovement";
DROP SEQUENCE IF EXISTS public."SchemeMaster_id_seq";
DROP TABLE IF EXISTS public."SchemeMaster";
...
DROP SEQUENCE IF EXISTS public."RetailerOrder_id_seq";
DROP SEQUENCE IF EXISTS public."RetailerOrderItem_id_seq";
DROP TABLE IF EXISTS public."RetailerOrderItem";
DROP TABLE IF EXISTS public."RetailerOrder";
...
DROP SEQUENCE IF EXISTS public."PricingMaster_id_seq";
DROP TABLE IF EXISTS public."PricingMaster";
DROP SEQUENCE IF EXISTS public."PaymentCollection_id_seq";
DROP TABLE IF EXISTS public."PaymentCollection";
DROP SEQUENCE IF EXISTS public."PackingType_id_seq";
DROP TABLE IF EXISTS public."PackingType";
DROP SEQUENCE IF EXISTS public."OutwardStock_id_seq";
DROP SEQUENCE IF EXISTS public."OutwardStockItem_id_seq";
DROP TABLE IF EXISTS public."OutwardStockItem";
DROP TABLE IF EXISTS public."OutwardStock";
...
DROP SEQUENCE IF EXISTS public."MeetingStockist_id_seq";
DROP TABLE IF EXISTS public."MeetingStockist";
DROP SEQUENCE IF EXISTS public."MeetingHospital_id_seq";
DROP TABLE IF EXISTS public."MeetingHospital";
DROP SEQUENCE IF EXISTS public."MeetingDoctor_id_seq";
DROP TABLE IF EXISTS public."MeetingDoctor";
DROP SEQUENCE IF EXISTS public."MeetingChemist_id_seq";
DROP TABLE IF EXISTS public."MeetingChemist";
DROP TABLE IF EXISTS public."Meeting";
DROP SEQUENCE IF EXISTS public."MR_id_seq";
DROP TABLE IF EXISTS public."MR";
DROP SEQUENCE IF EXISTS public."Ledger_id_seq";
DROP TABLE IF EXISTS public."Ledger";
DROP SEQUENCE IF EXISTS public."LeaveRequest_id_seq";
DROP TABLE IF EXISTS public."LeaveRequest";
DROP SEQUENCE IF EXISTS public."Lead_id_seq";
DROP TABLE IF EXISTS public."Lead";
DROP SEQUENCE IF EXISTS public."LRTracking_id_seq";
DROP TABLE IF EXISTS public."LRTracking";
DROP SEQUENCE IF EXISTS public."InwardStock_id_seq";
DROP SEQUENCE IF EXISTS public."InwardStockItem_id_seq";
DROP TABLE IF EXISTS public."InwardStockItem";
DROP TABLE IF EXISTS public."InwardStock";
DROP SEQUENCE IF EXISTS public."Invoice_id_seq";
DROP SEQUENCE IF EXISTS public."InvoiceItem_id_seq";
...
DROP SEQUENCE IF EXISTS public."HSNCode_id_seq";
DROP TABLE IF EXISTS public."HSNCode";
DROP SEQUENCE IF EXISTS public."GSTRecord_id_seq";
DROP TABLE IF EXISTS public."GSTRecord";
DROP SEQUENCE IF EXISTS public."FollowUp_id_seq";
DROP TABLE IF EXISTS public."FollowUp";
...
DROP SEQUENCE IF EXISTS public."ExpenseClaim_id_seq";
DROP TABLE IF EXISTS public."ExpenseClaim";
DROP TABLE IF EXISTS public."Expense";
DROP SEQUENCE IF EXISTS public."Doctor_id_seq";
DROP SEQUENCE IF EXISTS public."DoctorVisit_id_seq";
DROP TABLE IF EXISTS public."DoctorVisit";
DROP TABLE IF EXISTS public."Doctor";
DROP SEQUENCE IF EXISTS public."Distributor_id_seq";
DROP TABLE IF EXISTS public."Distributor";
DROP SEQUENCE IF EXISTS public."Dispatch_id_seq";
DROP TABLE IF EXISTS public."Dispatch";
DROP SEQUENCE IF EXISTS public."DeliveryTracking_id_seq";
DROP TABLE IF EXISTS public."DeliveryTracking";
DROP SEQUENCE IF EXISTS public."DailyReport_id_seq";
DROP TABLE IF EXISTS public."DailyReport";
DROP SEQUENCE IF EXISTS public."CreditNote_id_seq";
DROP SEQUENCE IF EXISTS public."CreditNoteItem_id_seq";
...
DROP SEQUENCE IF EXISTS public."CompanyFeaturePermission_id_seq";
DROP TABLE IF EXISTS public."CompanyFeaturePermission";
DROP TABLE IF EXISTS public."Company";
DROP SEQUENCE IF EXISTS public."Chemist_id_seq";
DROP SEQUENCE IF EXISTS public."ChemistVisit_id_seq";
DROP TABLE IF EXISTS public."ChemistVisit";
DROP TABLE IF EXISTS public."Chemist";
DROP SEQUENCE IF EXISTS public."Branch_id_seq";
DROP TABLE IF EXISTS public."Branch";
DROP SEQUENCE IF EXISTS public."Batch_id_seq";
...
\unrestrict rr6hsdZc4BI8ilUeaZ8Kq0iff1wLI4o2Yd3ApcHHIL9vifniYn8osykMDPofAbE
