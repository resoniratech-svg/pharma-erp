...
export default function ChemistVisits() {
  ...
  const handleAddVisit = async () => {
    ...
    const todayRecord = attendanceRecords.find((r: { date: string; latitude: number; longitude: number }) => r.date === newVisitDate) || attendanceRecords[0];
    ...
    },
    {
      ...
      render: (row) => (
        <div className="flex items-center gap-2">
          <button title="Map Location" className="text-[#163c78] hover:text-violet-700 hover:bg-[#163c78]/10 p-1.5 rounded-lg transition-colors">
