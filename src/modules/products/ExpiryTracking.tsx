...
export default function ExpiryTracking() {
  ...
  const columns: Column<ExpiryItem>[] = [
    ...
    },
    {
      key: "expDate",
      label: "Expiry Date",
      render: (row) => formatDate(row.expDate),
    },
    {
      key: "daysLeft",
      label: "Days Left",
  ...
  // Sort by latest created batches (using ID which is timestamp)
            ...
            <div>
              ...
              <div className="space-y-2">
                <DrawerField
                  ...
                  value={formatDate(selectedItem.mfgDate)}
                />
                <DrawerField
                  label="Expiry Date"
                  value={formatDate(selectedItem.expDate)}
                />
                <DrawerField
